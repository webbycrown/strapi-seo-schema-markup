...
import { EmptyStateLayout, Box, Table, Thead, Tr, Th, Typography, Tbody, Td, Button, Flex, SingleSelect, SingleSelectOption, Divider, Field, JSONInput, Toggle, TextInput } from "@strapi/design-system";
import { EmptyDocuments } from "@strapi/icons/symbols";
import { Page, useFetchClient, Layouts, useNotification } from "@strapi/strapi/admin";
import { P as PERMISSIONS, b as PLUGIN_ID, a as PLUGIN_API } from "./index-QfMZbdq5.mjs";
import { ArrowLeft } from "@strapi/icons";
const CollectionTypesListPage = () => {
  const { formatMessage } = useIntl();
  const { get } = useFetchClient();
  const [rows, setRows] = useState([]);
  const [configuredUids, setConfiguredUids] = useState(/* @__PURE__ */ new Set());
  ...
  return /* @__PURE__ */ jsxs(Page.Main, { tabIndex: -1, children: [
    ...
    /* @__PURE__ */ jsx(Layouts.Content, { children: rows.length === 0 ? /* @__PURE__ */ jsx(
      EmptyStateLayout,
      {
    ...
    ) : /* @__PURE__ */ jsx(Box, { background: "neutral0", shadow: "filterShadow", hasRadius: true, padding: 6, children: /* @__PURE__ */ jsxs(Table, { colCount: 5, rowCount: rows.length, children: [
      ...
      /* @__PURE__ */ jsx(Tbody, { children: rows.map((row) => /* @__PURE__ */ jsxs(Tr, { children: [
        /* @__PURE__ */ jsx(Td, { children: /* @__PURE__ */ jsx(Typography, { textColor: "neutral800", children: row.info?.displayName ?? "—" }) }),
        /* @__PURE__ */ jsx(Td, { children: /* @__PURE__ */ jsx(Typography, { textColor: "neutral800", children: row.apiID ?? "—" }) }),
        /* @__PURE__ */ jsx(Td, { children: /* @__PURE__ */ jsx(Typography, { textColor: configuredUids.has(row.uid) ? "success600" : "neutral600", children: configuredUids.has(row.uid) ? formatMessage({
        ...
        /* @__PURE__ */ jsx(Td, { children: /* @__PURE__ */ jsx(Typography, { textColor: "neutral600", variant: "omega", children: row.uid }) }),
        /* @__PURE__ */ jsx(Td, { children: /* @__PURE__ */ jsx(Link, { to: encodeURIComponent(row.uid), children: /* @__PURE__ */ jsx(Button, { size: "S", variant: "secondary", children: formatMessage({
...
const ProtectedCollectionTypesListPage = () => /* @__PURE__ */ jsx(Page.Protect, { permissions: PERMISSIONS.readCollectionTypes, children: /* @__PURE__ */ jsx(CollectionTypesListPage, {}) });
...
const TemplateJsonEditor = ({ value, onChange, fieldOptions = [], onRelationFieldInsert }) => {
  ...
  return /* @__PURE__ */ jsxs(Flex, { direction: "column", alignItems: "stretch", gap: 4, width: "100%", children: [
    /* @__PURE__ */ jsx(
      Box,
      {
        width: "100%",
        ...
        hasRadius: true,
        padding: 4,
        children: /* @__PURE__ */ jsxs(Flex, { direction: "column", alignItems: "stretch", gap: 3, width: "100%", children: [
          /* @__PURE__ */ jsxs(Flex, { justifyContent: "space-between", alignItems: "flex-start", gap: 4, width: "100%", children: [
            ...
            /* @__PURE__ */ jsx(Typography, { variant: "pi", textColor: "neutral500", children: fieldCountLabel })
          ] }),
          /* @__PURE__ */ jsx(Box, { width: "100%", children: /* @__PURE__ */ jsx(
            SingleSelect,
            {
              ...
              children: fieldOptions.map((opt) => /* @__PURE__ */ jsxs(SingleSelectOption, { value: opt.value, children: [
                opt.label,
                " (",
                `{{${opt.value}}}`,
                ")"
    ...
    /* @__PURE__ */ jsxs(Field.Root, { name: "templateJson", width: "100%", children: [
  ...
  return /* @__PURE__ */ jsxs(Page.Main, { tabIndex: -1, children: [
    /* @__PURE__ */ jsx(
      Layouts.Header,
      {
        ...
        navigationAction: /* @__PURE__ */ jsx(Link, { to: "..", children: /* @__PURE__ */ jsx(Button, { startIcon: /* @__PURE__ */ jsx(ArrowLeft, {}), variant: "tertiary", children: formatMessage({
          id: `${PLUGIN_ID}.template.back`,
          defaultMessage: "Back to list"
        }) }) }),
        primaryAction: /* @__PURE__ */ jsx(Button, { onClick: handleSave, loading: isSaving, children: formatMessage({
    ...
    /* @__PURE__ */ jsx(Layouts.Content, { children: /* @__PURE__ */ jsxs(Flex, { direction: "column", alignItems: "stretch", gap: 6, children: [
      /* @__PURE__ */ jsx(Box, { background: "neutral0", padding: 6, shadow: "filterShadow", hasRadius: true, children: /* @__PURE__ */ jsxs(Field.Root, { name: "enabled", children: [
        /* @__PURE__ */ jsx(Field.Label, { children: formatMessage({
      ...
      /* @__PURE__ */ jsx(Box, { background: "neutral0", padding: 6, shadow: "filterShadow", hasRadius: true, width: "100%", children: /* @__PURE__ */ jsxs(Flex, { direction: "column", alignItems: "stretch", gap: 4, width: "100%", children: [
        /* @__PURE__ */ jsxs(Flex, { direction: "column", gap: 1, alignItems: "flex-start", children: [
      ...
      /* @__PURE__ */ jsx(Box, { background: "neutral0", padding: 6, shadow: "filterShadow", hasRadius: true, children: /* @__PURE__ */ jsxs(Field.Root, { name: "populate", children: [
        /* @__PURE__ */ jsx(Field.Label, { children: formatMessage({
      ...
      /* @__PURE__ */ jsxs(Box, { background: "neutral0", padding: 6, shadow: "filterShadow", hasRadius: true, children: [
        /* @__PURE__ */ jsx(Typography, { variant: "delta", tag: "h2", paddingBottom: 2, children: formatMessage({
          id: `${PLUGIN_ID}.template.preview.title`,
          defaultMessage: "Preview (same as public API)"
        }) }),
        /* @__PURE__ */ jsx(Typography, { variant: "pi", textColor: "neutral600", paddingBottom: 4, children: formatMessage({
        ...
        /* @__PURE__ */ jsxs(Flex, { gap: 2, paddingBottom: 4, alignItems: "flex-end", wrap: "wrap", children: [
          /* @__PURE__ */ jsx(Box, { flex: "1", minWidth: "200px", children: /* @__PURE__ */ jsxs(Field.Root, { name: "previewDocumentId", children: [
            /* @__PURE__ */ jsx(Field.Label, { children: formatMessage({
          ...
          hasSlugField && /* @__PURE__ */ jsx(Box, { flex: "1", minWidth: "200px", children: /* @__PURE__ */ jsxs(Field.Root, { name: "previewSlug", children: [
            /* @__PURE__ */ jsx(Field.Label, { children: formatMessage({
          ...
          /* @__PURE__ */ jsx(Button, { variant: "secondary", onClick: handlePreview, loading: isPreviewing, children: formatMessage({
            id: `${PLUGIN_ID}.template.preview.run`,
            defaultMessage: "Preview"
          }) })
        ] }),
        previewSourceLabel && /* @__PURE__ */ jsx(Typography, { variant: "omega", fontWeight: "bold", textColor: "primary600", paddingBottom: 2, children: previewSourceLabel }),
        previewText !== "" && /* @__PURE__ */ jsx(JSONInput, { value: previewText, disabled: true, minHeight: "200px" })
      ] }),
      /* @__PURE__ */ jsxs(Typography, { variant: "pi", textColor: "neutral600", children: [
        /* @__PURE__ */ jsxs("strong", { children: [
          formatMessage({ id: `${PLUGIN_ID}.template.uid`, defaultMessage: "UID" }),
          ":"
        ] }),
        " ",
        contentTypeUid
...
const ProtectedTemplateEditPage = () => /* @__PURE__ */ jsx(Page.Protect, { permissions: PERMISSIONS.manageTemplate, children: /* @__PURE__ */ jsx(TemplateEditPage, {}) });
const Router = () => /* @__PURE__ */ jsxs(Routes, { children: [
  /* @__PURE__ */ jsx(Route, { index: true, element: /* @__PURE__ */ jsx(ProtectedCollectionTypesListPage, {}) }),
  /* @__PURE__ */ jsx(Route, { path: ":uid", element: /* @__PURE__ */ jsx(ProtectedTemplateEditPage, {}) })
] });
export {
  Router
};
