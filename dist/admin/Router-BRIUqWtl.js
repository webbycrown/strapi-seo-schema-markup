...
const index = require("./index-BXJLJvvW.js");
const icons = require("@strapi/icons");
const CollectionTypesListPage = () => {
  const { formatMessage } = reactIntl.useIntl();
  const { get } = admin.useFetchClient();
  const [rows, setRows] = react.useState([]);
  const [configuredUids, setConfiguredUids] = react.useState(/* @__PURE__ */ new Set());
    ...
    const load = async () => {
      ...
      try {
        ...
        if (!cancelled) {
          ...
          const visible = all.filter((row) => row.isDisplayed === true).sort(
            (a, b) => (a.info?.displayName ?? "").localeCompare(b.info?.displayName ?? "", void 0, {
              sensitivity: "base"
            })
          );
          setRows(visible);
          ...
          await Promise.all(
            visible.map(async (row) => {
              try {
                const res = await get(`${index.PLUGIN_API}/template`, {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(admin.Page.Main, { tabIndex: -1, children: [
    /* @__PURE__ */ jsxRuntime.jsx(
      admin.Layouts.Header,
      {
        ...
        subtitle: formatMessage(
          {
            id: `${index.PLUGIN_ID}.settings.description`,
            defaultMessage: "Default schema (JSON-LD) for {count} content types. Per-page schema in Content Manager overrides these defaults."
          },
          { count: rows.length }
        )
      }
    ),
    /* @__PURE__ */ jsxRuntime.jsx(admin.Layouts.Content, { children: rows.length === 0 ? /* @__PURE__ */ jsxRuntime.jsx(
      designSystem.EmptyStateLayout,
      {
        icon: /* @__PURE__ */ jsxRuntime.jsx(symbols.EmptyDocuments, { width: void 0, height: void 0 }),
        content: formatMessage({
          id: `${index.PLUGIN_ID}.settings.collection-types.empty`,
          defaultMessage: "No content types available for schema templates."
        })
      }
    ) : /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, { background: "neutral0", shadow: "filterShadow", hasRadius: true, padding: 6, children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Table, { colCount: 5, rowCount: rows.length, children: [
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.Thead, { children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Tr, { children: [
        /* @__PURE__ */ jsxRuntime.jsx(designSystem.Th, { children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { variant: "sigma", children: formatMessage({
          id: `${index.PLUGIN_ID}.settings.collection-types.column.displayName`,
          defaultMessage: "Display name"
        }) }) }),
        /* @__PURE__ */ jsxRuntime.jsx(designSystem.Th, { children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { variant: "sigma", children: formatMessage({
          id: `${index.PLUGIN_ID}.settings.collection-types.column.apiId`,
          defaultMessage: "API ID"
        }) }) }),
        /* @__PURE__ */ jsxRuntime.jsx(designSystem.Th, { children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { variant: "sigma", children: formatMessage({
          id: `${index.PLUGIN_ID}.settings.collection-types.column.global`,
          defaultMessage: "Global template"
        }) }) }),
        /* @__PURE__ */ jsxRuntime.jsx(designSystem.Th, { children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { variant: "sigma", children: formatMessage({
          id: `${index.PLUGIN_ID}.settings.collection-types.column.uid`,
          defaultMessage: "UID"
        }) }) }),
        /* @__PURE__ */ jsxRuntime.jsx(designSystem.Th, { children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { variant: "sigma", children: formatMessage({
          id: `${index.PLUGIN_ID}.settings.collection-types.column.actions`,
          defaultMessage: "Actions"
        }) }) })
      ] }) }),
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.Tbody, { children: rows.map((row) => /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Tr, { children: [
        /* @__PURE__ */ jsxRuntime.jsx(designSystem.Td, { children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { textColor: "neutral800", children: row.info?.displayName ?? "—" }) }),
        /* @__PURE__ */ jsxRuntime.jsx(designSystem.Td, { children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { textColor: "neutral800", children: row.apiID ?? "—" }) }),
        /* @__PURE__ */ jsxRuntime.jsx(designSystem.Td, { children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { textColor: configuredUids.has(row.uid) ? "success600" : "neutral600", children: configuredUids.has(row.uid) ? formatMessage({
          id: `${index.PLUGIN_ID}.settings.collection-types.configured`,
          defaultMessage: "Configured"
        }) : formatMessage({
          id: `${index.PLUGIN_ID}.settings.collection-types.notConfigured`,
          defaultMessage: "Not set"
        }) }) }),
        /* @__PURE__ */ jsxRuntime.jsx(designSystem.Td, { children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { textColor: "neutral600", variant: "omega", children: row.uid }) }),
        /* @__PURE__ */ jsxRuntime.jsx(designSystem.Td, { children: /* @__PURE__ */ jsxRuntime.jsx(reactRouterDom.Link, { to: encodeURIComponent(row.uid), children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Button, { size: "S", variant: "secondary", children: formatMessage({
          id: `${index.PLUGIN_ID}.settings.collection-types.configure`,
...
const ProtectedCollectionTypesListPage = () => /* @__PURE__ */ jsxRuntime.jsx(admin.Page.Protect, { permissions: index.PERMISSIONS.readCollectionTypes, children: /* @__PURE__ */ jsxRuntime.jsx(CollectionTypesListPage, {}) });
...
const TemplateJsonEditor = ({ value, onChange, fieldOptions = [], onRelationFieldInsert }) => {
  ...
  const fieldCountLabel = formatMessage(
    {
      id: `${index.PLUGIN_ID}.template.insertField.count`,
      defaultMessage: "{count} fields available"
    },
    { count: fieldOptions.length }
  );
  return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { direction: "column", alignItems: "stretch", gap: 4, width: "100%", children: [
    /* @__PURE__ */ jsxRuntime.jsx(
      designSystem.Box,
      {
        width: "100%",
        ...
        hasRadius: true,
        padding: 4,
        children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { direction: "column", alignItems: "stretch", gap: 3, width: "100%", children: [
          /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { justifyContent: "space-between", alignItems: "flex-start", gap: 4, width: "100%", children: [
            /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { direction: "column", gap: 1, alignItems: "flex-start", children: [
              /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { variant: "pi", fontWeight: "bold", children: formatMessage({
                id: `${index.PLUGIN_ID}.template.insertField.label`,
              ...
              /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { variant: "pi", textColor: "neutral600", children: formatMessage({
                id: `${index.PLUGIN_ID}.template.insertField.hint`,
                defaultMessage: "Place the cursor in the editor, then select a field. Relations are added to Populate automatically."
              }) })
            ] }),
            /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { variant: "pi", textColor: "neutral500", children: fieldCountLabel })
          ] }),
          /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, { width: "100%", children: /* @__PURE__ */ jsxRuntime.jsx(
            designSystem.SingleSelect,
            {
              ...
              placeholder: formatMessage({
                id: `${index.PLUGIN_ID}.template.insertField.placeholder`,
                defaultMessage: "Choose a field to insert…"
              }),
              onChange: handleFieldSelect,
              disabled: fieldOptions.length === 0,
              children: fieldOptions.map((opt) => /* @__PURE__ */ jsxRuntime.jsxs(designSystem.SingleSelectOption, { value: opt.value, children: [
                opt.label,
                " (",
                `{{${opt.value}}}`,
                ")"
    ...
    /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Field.Root, { name: "templateJson", width: "100%", children: [
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.Field.Label, { children: formatMessage({
        id: `${index.PLUGIN_ID}.template.json.editorLabel`,
      ...
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.Field.Hint, { children: formatMessage({
        id: `${index.PLUGIN_ID}.template.json.hint`,
...
const humanize = (name) => name.replace(/([A-Z])/g, " $1").replace(/^./, (c) => c.toUpperCase()).trim();
...
const TemplateEditPage = () => {
  const { uid: encodedUid } = reactRouterDom.useParams();
  ...
  const [displayName, setDisplayName] = react.useState(contentTypeUid);
  const [templateText, setTemplateText] = react.useState(() => stringifyJson(DEFAULT_TEMPLATE));
  const [populateText, setPopulateText] = react.useState("");
  const [enabled, setEnabled] = react.useState(true);
  const [previewDocumentId, setPreviewDocumentId] = react.useState("");
  const [previewSlug, setPreviewSlug] = react.useState("");
  const [hasSlugField, setHasSlugField] = react.useState(false);
  const [previewText, setPreviewText] = react.useState("");
  const [previewSource, setPreviewSource] = react.useState(null);
  const [fieldOptions, setFieldOptions] = react.useState([]);
  const parsePopulate = react.useCallback(() => {
    return populateText.split(",").map((s) => s.trim()).filter(Boolean);
  }, [populateText]);
  const handleRelationFieldInsert = react.useCallback((relationField) => {
    ...
    const load = async () => {
      ...
      try {
        const [templateRes, typesRes, configRes] = await Promise.all([
          get(`${index.PLUGIN_API}/template`, { params: { contentTypeUid } }),
        ...
        if (!cancelled) {
          toggleNotification({
            ...
            message: formatMessage({
              id: `${index.PLUGIN_ID}.template.load.error`,
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      toggleNotification({
        type: "danger",
        message: formatMessage({
          id: `${index.PLUGIN_ID}.template.json.invalid`,
    ...
    setIsSaving(true);
    try {
      await put(`${index.PLUGIN_API}/template`, {
        contentTypeUid,
        template,
      ...
      toggleNotification({
        type: "success",
        message: formatMessage({
          id: `${index.PLUGIN_ID}.template.save.success`,
      ...
      toggleNotification({
        type: "danger",
        message: formatMessage({
          id: `${index.PLUGIN_ID}.template.save.error`,
  ...
  const handlePreview = async () => {
    ...
    if (!documentId && !slug) {
      toggleNotification({
        type: "warning",
        message: formatMessage({
          id: `${index.PLUGIN_ID}.template.preview.noLookup`,
    ...
    try {
      ...
      const { data } = await post(`${index.PLUGIN_API}/template/preview`, body);
      ...
      toggleNotification({
        type: "danger",
        message: formatMessage({
          id: `${index.PLUGIN_ID}.template.preview.error`,
  ...
  const previewSourceLabel = previewSource === "entry" ? formatMessage({
    id: `${index.PLUGIN_ID}.template.preview.source.entry`,
    defaultMessage: "Source: entry (this page overrides the global template)"
  }) : previewSource === "global" ? formatMessage({
    id: `${index.PLUGIN_ID}.template.preview.source.global`,
    defaultMessage: "Source: global (saved template below)"
  }) : previewSource === "none" ? formatMessage({
    id: `${index.PLUGIN_ID}.template.preview.source.none`,
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(admin.Page.Main, { tabIndex: -1, children: [
    /* @__PURE__ */ jsxRuntime.jsx(
      admin.Layouts.Header,
      {
        title: formatMessage(
          {
            id: `${index.PLUGIN_ID}.template.title`,
            defaultMessage: "Structured data — {name}"
          },
          { name: displayName }
        ),
        subtitle: formatMessage({
          id: `${index.PLUGIN_ID}.template.subtitle`,
          defaultMessage: "Default JSON-LD for all entries. Pick fields from the list to insert variables. Entry-level schema overrides this."
        }),
        navigationAction: /* @__PURE__ */ jsxRuntime.jsx(reactRouterDom.Link, { to: "..", children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Button, { startIcon: /* @__PURE__ */ jsxRuntime.jsx(icons.ArrowLeft, {}), variant: "tertiary", children: formatMessage({
          id: `${index.PLUGIN_ID}.template.back`,
          defaultMessage: "Back to list"
        }) }) }),
        primaryAction: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Button, { onClick: handleSave, loading: isSaving, children: formatMessage({
          id: `${index.PLUGIN_ID}.template.save`,
          defaultMessage: "Save"
        }) })
      }
    ),
    /* @__PURE__ */ jsxRuntime.jsx(admin.Layouts.Content, { children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { direction: "column", alignItems: "stretch", gap: 6, children: [
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, { background: "neutral0", padding: 6, shadow: "filterShadow", hasRadius: true, children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Field.Root, { name: "enabled", children: [
        /* @__PURE__ */ jsxRuntime.jsx(designSystem.Field.Label, { children: formatMessage({
          id: `${index.PLUGIN_ID}.template.enabled`,
        ...
        /* @__PURE__ */ jsxRuntime.jsx(designSystem.Field.Hint, { children: formatMessage({
          id: `${index.PLUGIN_ID}.template.enabled.hint`,
          defaultMessage: "When off, only entry-level schema is used (if set)."
        }) })
      ] }) }),
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, { background: "neutral0", padding: 6, shadow: "filterShadow", hasRadius: true, width: "100%", children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { direction: "column", alignItems: "stretch", gap: 4, width: "100%", children: [
        /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { direction: "column", gap: 1, alignItems: "flex-start", children: [
          /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { variant: "delta", tag: "h2", children: formatMessage({
            id: `${index.PLUGIN_ID}.template.json.title`,
            defaultMessage: "Template (JSON-LD)"
          }) }),
          /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { variant: "pi", textColor: "neutral600", children: formatMessage({
            id: `${index.PLUGIN_ID}.template.json.sectionHint`,
            defaultMessage: "Default structured data for every entry of this type. Use the field picker or edit JSON directly."
          }) })
        ] }),
        /* @__PURE__ */ jsxRuntime.jsx(
          TemplateJsonEditor,
      ...
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, { background: "neutral0", padding: 6, shadow: "filterShadow", hasRadius: true, children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Field.Root, { name: "populate", children: [
        /* @__PURE__ */ jsxRuntime.jsx(designSystem.Field.Label, { children: formatMessage({
          id: `${index.PLUGIN_ID}.template.populate`,
        ...
        /* @__PURE__ */ jsxRuntime.jsx(designSystem.Field.Hint, { children: formatMessage({
          id: `${index.PLUGIN_ID}.template.populate.hint`,
          defaultMessage: "Comma-separated top-level fields (e.g. author, category, components). Components and dynamic zones are deep-populated automatically."
        }) })
      ] }) }),
      /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Box, { background: "neutral0", padding: 6, shadow: "filterShadow", hasRadius: true, children: [
        /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { variant: "delta", tag: "h2", paddingBottom: 2, children: formatMessage({
          id: `${index.PLUGIN_ID}.template.preview.title`,
          defaultMessage: "Preview (same as public API)"
        }) }),
        /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { variant: "pi", textColor: "neutral600", paddingBottom: 4, children: formatMessage({
          id: `${index.PLUGIN_ID}.template.preview.hint`,
          defaultMessage: "Uses saved global template only. Entry schema wins if set on that document. Save before previewing. Lookup by document ID or slug (same as GET /api/strapi-seo-schema-markup/schema)."
        }) }),
        /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { gap: 2, paddingBottom: 4, alignItems: "flex-end", wrap: "wrap", children: [
          /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, { flex: "1", minWidth: "200px", children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Field.Root, { name: "previewDocumentId", children: [
            /* @__PURE__ */ jsxRuntime.jsx(designSystem.Field.Label, { children: formatMessage({
              id: `${index.PLUGIN_ID}.template.preview.documentId`,
          ...
          hasSlugField && /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, { flex: "1", minWidth: "200px", children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Field.Root, { name: "previewSlug", children: [
            /* @__PURE__ */ jsxRuntime.jsx(designSystem.Field.Label, { children: formatMessage({
              id: `${index.PLUGIN_ID}.template.preview.slug`,
              defaultMessage: "Slug"
            }) }),
            /* @__PURE__ */ jsxRuntime.jsx(
              designSystem.TextInput,
          ...
          /* @__PURE__ */ jsxRuntime.jsx(designSystem.Button, { variant: "secondary", onClick: handlePreview, loading: isPreviewing, children: formatMessage({
            id: `${index.PLUGIN_ID}.template.preview.run`,
            defaultMessage: "Preview"
          }) })
        ] }),
        previewSourceLabel && /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { variant: "omega", fontWeight: "bold", textColor: "primary600", paddingBottom: 2, children: previewSourceLabel }),
        previewText !== "" && /* @__PURE__ */ jsxRuntime.jsx(designSystem.JSONInput, { value: previewText, disabled: true, minHeight: "200px" })
      ] }),
      /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Typography, { variant: "pi", textColor: "neutral600", children: [
        /* @__PURE__ */ jsxRuntime.jsxs("strong", { children: [
          formatMessage({ id: `${index.PLUGIN_ID}.template.uid`, defaultMessage: "UID" }),
          ":"
        ] }),
        " ",
        contentTypeUid
...
const ProtectedTemplateEditPage = () => /* @__PURE__ */ jsxRuntime.jsx(admin.Page.Protect, { permissions: index.PERMISSIONS.manageTemplate, children: /* @__PURE__ */ jsxRuntime.jsx(TemplateEditPage, {}) });
const Router = () => /* @__PURE__ */ jsxRuntime.jsxs(reactRouterDom.Routes, { children: [
  /* @__PURE__ */ jsxRuntime.jsx(reactRouterDom.Route, { index: true, element: /* @__PURE__ */ jsxRuntime.jsx(ProtectedCollectionTypesListPage, {}) }),
  /* @__PURE__ */ jsxRuntime.jsx(reactRouterDom.Route, { path: ":uid", element: /* @__PURE__ */ jsxRuntime.jsx(ProtectedTemplateEditPage, {}) })
] });
